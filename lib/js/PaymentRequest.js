...
export default class PaymentRequest {
  ...
  _handleUserAccept(details: {
    ...
    const paymentResponse = new PaymentResponse({
      ...
      shippingAddress: this._options.requestShipping ? details.shippingContact : null,
      details: this._getPlatformDetails(details),
      shippingOption: IS_IOS ? this._shippingOption : null,
      payerName: this._options.requestPayerName ? details.shippingContact.recipient : null,
      payerPhone: this._options.requestPayerPhone ? details.shippingContact.phone : null,
